...
#[uniffi::export]
pub fn all_fiat_currencies() -> Vec<FiatCurrency> {
    FiatCurrency::iter().collect()
}

#[uniffi::export]
pub fn is_fiat_currency_symbol(symbol: &str) -> bool {
    FiatCurrency::is_symbol(symbol)
}

#[uniffi::export]
pub fn fiat_currency_to_string(fiat_currency: FiatCurrency) -> String {
    fiat_currency.to_string()
}

#[uniffi::export]
pub fn fiat_currency_symbol(fiat_currency: FiatCurrency) -> String {
    fiat_currency.symbol().to_string()
}

#[uniffi::export]
pub fn fiat_currency_emoji(fiat_currency: FiatCurrency) -> String {
    fiat_currency.emoji().to_string()
}

#[uniffi::export]
pub fn fiat_currency_suffix(fiat_currency: FiatCurrency) -> String {
