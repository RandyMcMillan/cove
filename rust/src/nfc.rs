...
use cove_nfc::{NfcReaderError, ParseResult};
...
pub struct FfiNfcReader(Arc<Mutex<cove_nfc::NfcReader>>);

#[uniffi::export]
impl FfiNfcReader {
    #[uniffi::constructor]
    pub fn new() -> Self {
        let reader = cove_nfc::NfcReader::new();
...
impl NfcConst {
    fn new() -> Self {
        Self {
            number_of_blocks_per_chunk: cove_nfc::NUMBER_OF_BLOCKS_PER_CHUNK,
            bytes_per_block: cove_nfc::BYTES_PER_BLOCK,
        }
    }
}
