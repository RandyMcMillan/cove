...
//
    ...
    public struct ScanResult {
        ...
        public let data: ScanResultData
    ...
    /// The scan result will either be a string or binary data
    @available(macCatalyst 14.0, *)
    public enum ScanResultData: Hashable {
        case string(String)
        case data(Data)
    }
    ...
    public enum ScanMode {
        ...
        case continuousExcept(ignoredList: Set<ScanResultData>)
    ...
    public struct CodeScannerView: UIViewControllerRepresentable {
        ...
        public func updateUIViewController(
            _ uiViewController: ScannerViewController, context _: Context
        ) {
