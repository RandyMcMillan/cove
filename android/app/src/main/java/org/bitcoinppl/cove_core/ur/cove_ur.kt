...
package org.bitcoinppl.cove_core.ur
   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.ffi_cove_ur_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_cove_ur_rustbuffer_free(buf, status)
        }
    }
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "cove_ur"))
        uniffiCheckContractApiVersion(this)
        uniffiCheckApiChecksums(this)
    }
    external fun uniffi_cove_ur_checksum_method_cryptohdkey_encode(
    ): Short
    external fun uniffi_cove_ur_checksum_method_cryptopsbt_encode(
    ): Short
    external fun uniffi_cove_ur_checksum_method_cryptopsbt_to_psbt_bytes(
    ): Short
    external fun uniffi_cove_ur_checksum_method_cryptopsbt_to_ur(
    ): Short
    external fun uniffi_cove_ur_checksum_method_cryptoseed_encode(
    ): Short
    external fun uniffi_cove_ur_checksum_method_cryptoseed_entropy(
    ): Short
    external fun uniffi_cove_ur_checksum_method_cryptoseed_get_creation_date(
    ): Short
    external fun uniffi_cove_ur_checksum_method_cryptoseed_get_name(
    ): Short
    external fun uniffi_cove_ur_checksum_method_cryptoseed_get_note(
    ): Short
    external fun uniffi_cove_ur_checksum_constructor_cryptohdkey_decode(
    ): Short
    external fun uniffi_cove_ur_checksum_constructor_cryptopsbt_decode(
    ): Short
    external fun uniffi_cove_ur_checksum_constructor_cryptopsbt_from_psbt_bytes(
    ): Short
    external fun uniffi_cove_ur_checksum_constructor_cryptopsbt_from_ur(
    ): Short
    external fun uniffi_cove_ur_checksum_constructor_cryptoseed_decode(
    ): Short
    external fun uniffi_cove_ur_checksum_constructor_cryptoseed_from_entropy(
    ): Short
    external fun uniffi_cove_ur_checksum_constructor_cryptoseed_from_entropy_with_metadata(
    ): Short
...
internal object UniffiLib {
    ...
    external fun ffi_cove_ur_rust_future_cancel_u8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_i8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_u16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_i16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_u32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_i32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_u64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_i64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_f32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_f64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_rust_buffer(`handle`: Long,
    ): Unit
    ...
    external fun ffi_cove_ur_rust_future_cancel_void(`handle`: Long,
    ): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_cove_ur_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_cove_ur_checksum_method_cryptoseed_get_creation_date() != 4217.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_cove_ur_checksum_method_cryptoseed_get_name() != 47847.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
 ...
 * crypto-hdkey: Hierarchical Deterministic Key (BIP32)
 */
open class CryptoHdkey: Disposable, AutoCloseable, CryptoHdkeyInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_cove_ur_fn_free_cryptohdkey(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_cove_ur_fn_clone_cryptohdkey(handle, status)
        }
    }
    ...
    UniffiLib.uniffi_cove_ur_fn_method_cryptohdkey_encode(
        it,
        _status)
}
    }
 ...
 * @suppress
 */
public object FfiConverterTypeCryptoHdkey: FfiConverter<CryptoHdkey, Long> {
    override fun lower(value: CryptoHdkey): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): CryptoHdkey {
        return CryptoHdkey(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): CryptoHdkey {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: CryptoHdkey) = 8UL

    override fun write(value: CryptoHdkey, buf: ByteBuffer) {
...
open class CryptoPsbt: Disposable, AutoCloseable, CryptoPsbtInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_cove_ur_fn_free_cryptopsbt(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_cove_ur_fn_clone_cryptopsbt(handle, status)
        }
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(UrException) { _status ->
    UniffiLib.uniffi_cove_ur_fn_method_cryptopsbt_encode(
        it,
        _status)
}
    }
    ...
    UniffiLib.uniffi_cove_ur_fn_method_cryptopsbt_to_psbt_bytes(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(UrException) { _status ->
    UniffiLib.uniffi_cove_ur_fn_method_cryptopsbt_to_ur(
        it,
        _status)
}
    }
 ...
 * @suppress
 */
public object FfiConverterTypeCryptoPsbt: FfiConverter<CryptoPsbt, Long> {
    override fun lower(value: CryptoPsbt): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): CryptoPsbt {
        return CryptoPsbt(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): CryptoPsbt {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: CryptoPsbt) = 8UL

    override fun write(value: CryptoPsbt, buf: ByteBuffer) {
        buf.putLong(lower(value))
    }
}
...
open class CryptoSeed: Disposable, AutoCloseable, CryptoSeedInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_cove_ur_fn_free_cryptoseed(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_cove_ur_fn_clone_cryptoseed(handle, status)
        }
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(UrException) { _status ->
    UniffiLib.uniffi_cove_ur_fn_method_cryptoseed_encode(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_cove_ur_fn_method_cryptoseed_entropy(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_cove_ur_fn_method_cryptoseed_get_creation_date(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_cove_ur_fn_method_cryptoseed_get_name(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_cove_ur_fn_method_cryptoseed_get_note(
        it,
        _status)
}
    }
 ...
 * @suppress
 */
public object FfiConverterTypeCryptoSeed: FfiConverter<CryptoSeed, Long> {
    override fun lower(value: CryptoSeed): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): CryptoSeed {
        return CryptoSeed(UniffiWithHandle, value)
    }

    override fun read(buf: ByteBuffer): CryptoSeed {
        return lift(buf.getLong())
    }

    override fun allocationSize(value: CryptoSeed) = 8UL

    override fun write(value: CryptoSeed, buf: ByteBuffer) {
        buf.putLong(lower(value))
    }
}
...
sealed class UrException: kotlin.Exception() {
    ...
    override fun toString(): String {
        return FfiConverterString.lift(
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_cove_ur_fn_method_urerror_uniffi_trait_display(FfiConverterTypeUrError.lower(this),
        _status)
}
    )
    }

    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<UrException> {
...
public object FfiConverterTypeUrError : FfiConverterRustBuffer<UrException> {
    override fun read(buf: ByteBuffer): UrException {
        ...
        return when(buf.getInt()) {
            ...
            2 -> UrException.CborDecodeException(
                FfiConverterString.read(buf),
                )
            3 -> UrException.InvalidField(
                FfiConverterString.read(buf),
                )
            4 -> UrException.MissingField(
                FfiConverterString.read(buf),
                )
            5 -> UrException.InvalidKeyDataLength(
                FfiConverterULong.read(buf),
                FfiConverterULong.read(buf),
                )
            6 -> UrException.InvalidTag(
                FfiConverterULong.read(buf),
                FfiConverterULong.read(buf),
                )
            7 -> UrException.InvalidPayloadLength(
                FfiConverterString.read(buf),
                )
            8 -> UrException.UrParseException(
                FfiConverterString.read(buf),
                )
            9 -> UrException.InvalidOperation(
                FfiConverterString.read(buf),
                )
            10 -> UrException.InvalidKeyData(
                FfiConverterString.read(buf),
                )
            11 -> UrException.MasterKeyNotAllowed()
            12 -> UrException.InvalidUtf8(
                FfiConverterString.read(buf),
                )
    ...
    override fun allocationSize(value: UrException): ULong {
        return when(value) {
            is UrException.CborEncodeException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is UrException.CborDecodeException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is UrException.InvalidField -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is UrException.MissingField -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is UrException.InvalidKeyDataLength -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterULong.allocationSize(value.`expected`)
                + FfiConverterULong.allocationSize(value.`actual`)
            )
            is UrException.InvalidTag -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterULong.allocationSize(value.`expected`)
                + FfiConverterULong.allocationSize(value.`actual`)
            )
            is UrException.InvalidPayloadLength -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is UrException.UrParseException -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is UrException.InvalidOperation -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is UrException.InvalidKeyData -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
            is UrException.MasterKeyNotAllowed -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is UrException.InvalidUtf8 -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.v1)
            )
